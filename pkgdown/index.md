...
# phenoOncoX <a href="https://sigven.github.io/phenoOncoX/"><img src="man/figures/logo.png" align="right" height="130" width="113"/></a>
...
The mapping established within **phenoOncoX** is semi-manually curated, using 
...
* [Installation instructions](articles/phenoOncoX.html#installation)
* [Usage examples](articles/phenoOncoX.html#get-oncotree-terms)
...
Please note that this project is released with a [Contributor Code of Conduct](https://github.com/sigven/phenoOncoX/blob/main/.github/CODE_OF_CONDUCT.md). By participating in this project you agree to abide by its terms.
