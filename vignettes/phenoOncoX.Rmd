...
bibliography: '`r system.file("bibliography.bib", package = "phenoOncoX")`'
nocite: |
...
remotes::install_github('sigven/phenoOncoX')
```
...
oncotree <- get_tree(cache_dir = download_dir, max_tree_depth = 2)
...
oncoterms <- get_terms(cache_dir = download_dir)
...
oncoterms_prostate <- get_terms(
  cache_dir = download_dir, site = "Prostate")
